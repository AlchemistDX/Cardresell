...
import {
  SUB, K, store, sets, seen, reset, kv, SVC, DS, EP, fakeReq, fakeRes, seed, fail,
} from './_draftHarness.mjs';

// The scaffold above was extracted to _draftHarness.mjs on 2026-09-06 so the
// D2.1 fixture generator could reuse it instead of making a third copy. No
// behaviour changed; this suite asserted 56/0 before and after.
